...
part of 'patient_adherence_entity.dart';
...
@override
String toString() {
  return 'PatientAdherenceEntity(id: $id, patientName: $patientName, age: $age, gender: $gender, condition: $condition, totalMedications: $totalMedications, activeMedications: $activeMedications, adherenceRate: $adherenceRate, adherenceLevel: $adherenceLevel, dosesScheduled: $dosesScheduled, dosesTaken: $dosesTaken, dosesMissed: $dosesMissed, dosesDelayed: $dosesDelayed, lastDoseTime: $lastDoseTime, nextDoseTime: $nextDoseTime, consecutiveMissedDoses: $consecutiveMissedDoses, requiresIntervention: $requiresIntervention, riskFactors: $riskFactors)';
}
...
/// @nodoc
abstract mixin class $PatientAdherenceEntityCopyWith<$Res>  {
  factory $PatientAdherenceEntityCopyWith(PatientAdherenceEntity value, $Res Function(PatientAdherenceEntity) _then) = _$PatientAdherenceEntityCopyWithImpl;
@useResult
$Res call({
 String id, String patientName, int age, String gender, String condition, int totalMedications, int activeMedications, double adherenceRate, AdherenceLevel adherenceLevel, int dosesScheduled, int dosesTaken, int dosesMissed, int dosesDelayed, DateTime lastDoseTime, DateTime nextDoseTime, int consecutiveMissedDoses, bool requiresIntervention, List<String> riskFactors
});
...
/// @nodoc
class _$PatientAdherenceEntityCopyWithImpl<$Res>
    implements $PatientAdherenceEntityCopyWith<$Res> {
  _$PatientAdherenceEntityCopyWithImpl(this._self, this._then);

  final PatientAdherenceEntity _self;
  final $Res Function(PatientAdherenceEntity) _then;
...
as AdherenceLevel,dosesScheduled: null == dosesScheduled ? _self.dosesScheduled : dosesScheduled // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [PatientAdherenceEntity].
extension PatientAdherenceEntityPatterns on PatientAdherenceEntity {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PatientAdherenceEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PatientAdherenceEntity() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PatientAdherenceEntity value)  $default,){
final _that = this;
switch (_that) {
case _PatientAdherenceEntity():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PatientAdherenceEntity value)?  $default,){
final _that = this;
switch (_that) {
case _PatientAdherenceEntity() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String patientName,  int age,  String gender,  String condition,  int totalMedications,  int activeMedications,  double adherenceRate,  AdherenceLevel adherenceLevel,  int dosesScheduled,  int dosesTaken,  int dosesMissed,  int dosesDelayed,  DateTime lastDoseTime,  DateTime nextDoseTime,  int consecutiveMissedDoses,  bool requiresIntervention,  List<String> riskFactors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PatientAdherenceEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String patientName,  int age,  String gender,  String condition,  int totalMedications,  int activeMedications,  double adherenceRate,  AdherenceLevel adherenceLevel,  int dosesScheduled,  int dosesTaken,  int dosesMissed,  int dosesDelayed,  DateTime lastDoseTime,  DateTime nextDoseTime,  int consecutiveMissedDoses,  bool requiresIntervention,  List<String> riskFactors)  $default,) {final _that = this;
switch (_that) {
case _PatientAdherenceEntity():
return $default(_that.id,_that.patientName,_that.age,_that.gender,_that.condition,_that.totalMedications,_that.activeMedications,_that.adherenceRate,_that.adherenceLevel,_that.dosesScheduled,_that.dosesTaken,_that.dosesMissed,_that.dosesDelayed,_that.lastDoseTime,_that.nextDoseTime,_that.consecutiveMissedDoses,_that.requiresIntervention,_that.riskFactors);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String patientName,  int age,  String gender,  String condition,  int totalMedications,  int activeMedications,  double adherenceRate,  AdherenceLevel adherenceLevel,  int dosesScheduled,  int dosesTaken,  int dosesMissed,  int dosesDelayed,  DateTime lastDoseTime,  DateTime nextDoseTime,  int consecutiveMissedDoses,  bool requiresIntervention,  List<String> riskFactors)?  $default,) {final _that = this;
switch (_that) {
case _PatientAdherenceEntity() when $default != null:
return $default(_that.id,_that.patientName,_that.age,_that.gender,_that.condition,_that.totalMedications,_that.activeMedications,_that.adherenceRate,_that.adherenceLevel,_that.dosesScheduled,_that.dosesTaken,_that.dosesMissed,_that.dosesDelayed,_that.lastDoseTime,_that.nextDoseTime,_that.consecutiveMissedDoses,_that.requiresIntervention,_that.riskFactors);case _:
  return null;
...
class _PatientAdherenceEntity implements PatientAdherenceEntity {
  const _PatientAdherenceEntity({required this.id, required this.patientName, required this.age, required this.gender, required this.condition, required this.totalMedications, required this.activeMedications, required this.adherenceRate, required this.adherenceLevel, required this.dosesScheduled, required this.dosesTaken, required this.dosesMissed, required this.dosesDelayed, required this.lastDoseTime, required this.nextDoseTime, required this.consecutiveMissedDoses, required this.requiresIntervention, required final  List<String> riskFactors}): _riskFactors = riskFactors;
...
@override final  AdherenceLevel adherenceLevel;
...
@pragma('vm:prefer-inline')
_$PatientAdherenceEntityCopyWith<_PatientAdherenceEntity> get copyWith => __$PatientAdherenceEntityCopyWithImpl<_PatientAdherenceEntity>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PatientAdherenceEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.patientName, patientName) || other.patientName == patientName)&&(identical(other.age, age) || other.age == age)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.condition, condition) || other.condition == condition)&&(identical(other.totalMedications, totalMedications) || other.totalMedications == totalMedications)&&(identical(other.activeMedications, activeMedications) || other.activeMedications == activeMedications)&&(identical(other.adherenceRate, adherenceRate) || other.adherenceRate == adherenceRate)&&(identical(other.adherenceLevel, adherenceLevel) || other.adherenceLevel == adherenceLevel)&&(identical(other.dosesScheduled, dosesScheduled) || other.dosesScheduled == dosesScheduled)&&(identical(other.dosesTaken, dosesTaken) || other.dosesTaken == dosesTaken)&&(identical(other.dosesMissed, dosesMissed) || other.dosesMissed == dosesMissed)&&(identical(other.dosesDelayed, dosesDelayed) || other.dosesDelayed == dosesDelayed)&&(identical(other.lastDoseTime, lastDoseTime) || other.lastDoseTime == lastDoseTime)&&(identical(other.nextDoseTime, nextDoseTime) || other.nextDoseTime == nextDoseTime)&&(identical(other.consecutiveMissedDoses, consecutiveMissedDoses) || other.consecutiveMissedDoses == consecutiveMissedDoses)&&(identical(other.requiresIntervention, requiresIntervention) || other.requiresIntervention == requiresIntervention)&&const DeepCollectionEquality().equals(other._riskFactors, _riskFactors));
}
...
/// @nodoc
abstract mixin class _$PatientAdherenceEntityCopyWith<$Res> implements $PatientAdherenceEntityCopyWith<$Res> {
  factory _$PatientAdherenceEntityCopyWith(_PatientAdherenceEntity value, $Res Function(_PatientAdherenceEntity) _then) = __$PatientAdherenceEntityCopyWithImpl;
@override @useResult
$Res call({
 String id, String patientName, int age, String gender, String condition, int totalMedications, int activeMedications, double adherenceRate, AdherenceLevel adherenceLevel, int dosesScheduled, int dosesTaken, int dosesMissed, int dosesDelayed, DateTime lastDoseTime, DateTime nextDoseTime, int consecutiveMissedDoses, bool requiresIntervention, List<String> riskFactors
});
...
/// @nodoc
class __$PatientAdherenceEntityCopyWithImpl<$Res>
    implements _$PatientAdherenceEntityCopyWith<$Res> {
  __$PatientAdherenceEntityCopyWithImpl(this._self, this._then);

  final _PatientAdherenceEntity _self;
  final $Res Function(_PatientAdherenceEntity) _then;

/// Create a copy of PatientAdherenceEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? patientName = null,Object? age = null,Object? gender = null,Object? condition = null,Object? totalMedications = null,Object? activeMedications = null,Object? adherenceRate = null,Object? adherenceLevel = null,Object? dosesScheduled = null,Object? dosesTaken = null,Object? dosesMissed = null,Object? dosesDelayed = null,Object? lastDoseTime = null,Object? nextDoseTime = null,Object? consecutiveMissedDoses = null,Object? requiresIntervention = null,Object? riskFactors = null,}) {
  return _then(_PatientAdherenceEntity(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,patientName: null == patientName ? _self.patientName : patientName // ignore: cast_nullable_to_non_nullable
as String,age: null == age ? _self.age : age // ignore: cast_nullable_to_non_nullable
as int,gender: null == gender ? _self.gender : gender // ignore: cast_nullable_to_non_nullable
