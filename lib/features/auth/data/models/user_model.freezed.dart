...
@override
String toString() {
  return 'UserModel(id: $id, email: $email, name: $name, role: $role, organizationId: $organizationId, organizationName: $organizationName, phone: $phone, avatarUrl: $avatarUrl, lastLoginAt: $lastLoginAt, createdAt: $createdAt)';
}
...
class _UserModel extends UserModel {
  const _UserModel({required this.id, required this.email, required this.name, required this.role, this.organizationId, this.organizationName, this.phone, this.avatarUrl, this.lastLoginAt, required this.createdAt}): super._();
