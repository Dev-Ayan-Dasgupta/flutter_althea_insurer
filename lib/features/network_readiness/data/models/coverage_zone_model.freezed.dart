...
/// @nodoc
abstract mixin class $CoverageZoneModelCopyWith<$Res>  {
  factory $CoverageZoneModelCopyWith(CoverageZoneModel value, $Res Function(CoverageZoneModel) _then) = _$CoverageZoneModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$CoverageZoneModelCopyWithImpl<$Res>
    implements $CoverageZoneModelCopyWith<$Res> {
  _$CoverageZoneModelCopyWithImpl(this._self, this._then);

  final CoverageZoneModel _self;
  final $Res Function(CoverageZoneModel) _then;
...
/// Adds pattern-matching-related methods to [CoverageZoneModel].
extension CoverageZoneModelPatterns on CoverageZoneModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CoverageZoneModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CoverageZoneModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CoverageZoneModel value)  $default,){
final _that = this;
switch (_that) {
case _CoverageZoneModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CoverageZoneModel value)?  $default,){
final _that = this;
switch (_that) {
case _CoverageZoneModel() when $default != null:
return $default(_that);case _:
...
class _CoverageZoneModel extends CoverageZoneModel {
  const _CoverageZoneModel({required this.id, required this.zoneName, required this.centerLatitude, required this.centerLongitude, required this.radiusKm, required this.populationCovered, required this.activeAssets, required this.coverageScore, required this.avgResponseTimeMinutes, required this.hasAdequateCoverage}): super._();
  factory _CoverageZoneModel.fromJson(Map<String, dynamic> json) => _$CoverageZoneModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$CoverageZoneModelCopyWith<_CoverageZoneModel> get copyWith => __$CoverageZoneModelCopyWithImpl<_CoverageZoneModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$CoverageZoneModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CoverageZoneModel&&(identical(other.id, id) || other.id == id)&&(identical(other.zoneName, zoneName) || other.zoneName == zoneName)&&(identical(other.centerLatitude, centerLatitude) || other.centerLatitude == centerLatitude)&&(identical(other.centerLongitude, centerLongitude) || other.centerLongitude == centerLongitude)&&(identical(other.radiusKm, radiusKm) || other.radiusKm == radiusKm)&&(identical(other.populationCovered, populationCovered) || other.populationCovered == populationCovered)&&(identical(other.activeAssets, activeAssets) || other.activeAssets == activeAssets)&&(identical(other.coverageScore, coverageScore) || other.coverageScore == coverageScore)&&(identical(other.avgResponseTimeMinutes, avgResponseTimeMinutes) || other.avgResponseTimeMinutes == avgResponseTimeMinutes)&&(identical(other.hasAdequateCoverage, hasAdequateCoverage) || other.hasAdequateCoverage == hasAdequateCoverage));
}
...
/// @nodoc
abstract mixin class _$CoverageZoneModelCopyWith<$Res> implements $CoverageZoneModelCopyWith<$Res> {
  factory _$CoverageZoneModelCopyWith(_CoverageZoneModel value, $Res Function(_CoverageZoneModel) _then) = __$CoverageZoneModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String zoneName, double centerLatitude, double centerLongitude, double radiusKm, int populationCovered, int activeAssets, double coverageScore, int avgResponseTimeMinutes, bool hasAdequateCoverage
});
...
/// @nodoc
class __$CoverageZoneModelCopyWithImpl<$Res>
    implements _$CoverageZoneModelCopyWith<$Res> {
  __$CoverageZoneModelCopyWithImpl(this._self, this._then);

  final _CoverageZoneModel _self;
  final $Res Function(_CoverageZoneModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? zoneName = null,Object? centerLatitude = null,Object? centerLongitude = null,Object? radiusKm = null,Object? populationCovered = null,Object? activeAssets = null,Object? coverageScore = null,Object? avgResponseTimeMinutes = null,Object? hasAdequateCoverage = null,}) {
  return _then(_CoverageZoneModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,zoneName: null == zoneName ? _self.zoneName : zoneName // ignore: cast_nullable_to_non_nullable
as String,centerLatitude: null == centerLatitude ? _self.centerLatitude : centerLatitude // ignore: cast_nullable_to_non_nullable
as double,centerLongitude: null == centerLongitude ? _self.centerLongitude : centerLongitude // ignore: cast_nullable_to_non_nullable
