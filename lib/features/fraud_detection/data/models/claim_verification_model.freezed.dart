...
/// @nodoc
abstract mixin class $ClaimVerificationModelCopyWith<$Res>  {
  factory $ClaimVerificationModelCopyWith(ClaimVerificationModel value, $Res Function(ClaimVerificationModel) _then) = _$ClaimVerificationModelCopyWithImpl;
@useResult
$Res call({
 String id, String claimId, String patientName, String providerName, double claimAmount, DateTime claimDate, String status, List<String> checksCompleted, List<String> checksPending, int totalChecks, int passedChecks, int failedChecks, double verificationScore, List<String> redFlags, List<String> verifiedDocuments, String? assignedVerifier, DateTime? completedAt, String? recommendation
});
...
/// @nodoc
class _$ClaimVerificationModelCopyWithImpl<$Res>
    implements $ClaimVerificationModelCopyWith<$Res> {
  _$ClaimVerificationModelCopyWithImpl(this._self, this._then);

  final ClaimVerificationModel _self;
  final $Res Function(ClaimVerificationModel) _then;
...
as String,checksCompleted: null == checksCompleted ? _self.checksCompleted : checksCompleted // ignore: cast_nullable_to_non_nullable
as List<String>,checksPending: null == checksPending ? _self.checksPending : checksPending // ignore: cast_nullable_to_non_nullable
as List<String>,totalChecks: null == totalChecks ? _self.totalChecks : totalChecks // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [ClaimVerificationModel].
extension ClaimVerificationModelPatterns on ClaimVerificationModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ClaimVerificationModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ClaimVerificationModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ClaimVerificationModel value)  $default,){
final _that = this;
switch (_that) {
case _ClaimVerificationModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ClaimVerificationModel value)?  $default,){
final _that = this;
switch (_that) {
case _ClaimVerificationModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String claimId,  String patientName,  String providerName,  double claimAmount,  DateTime claimDate,  String status,  List<String> checksCompleted,  List<String> checksPending,  int totalChecks,  int passedChecks,  int failedChecks,  double verificationScore,  List<String> redFlags,  List<String> verifiedDocuments,  String? assignedVerifier,  DateTime? completedAt,  String? recommendation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ClaimVerificationModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String claimId,  String patientName,  String providerName,  double claimAmount,  DateTime claimDate,  String status,  List<String> checksCompleted,  List<String> checksPending,  int totalChecks,  int passedChecks,  int failedChecks,  double verificationScore,  List<String> redFlags,  List<String> verifiedDocuments,  String? assignedVerifier,  DateTime? completedAt,  String? recommendation)  $default,) {final _that = this;
switch (_that) {
case _ClaimVerificationModel():
return $default(_that.id,_that.claimId,_that.patientName,_that.providerName,_that.claimAmount,_that.claimDate,_that.status,_that.checksCompleted,_that.checksPending,_that.totalChecks,_that.passedChecks,_that.failedChecks,_that.verificationScore,_that.redFlags,_that.verifiedDocuments,_that.assignedVerifier,_that.completedAt,_that.recommendation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String claimId,  String patientName,  String providerName,  double claimAmount,  DateTime claimDate,  String status,  List<String> checksCompleted,  List<String> checksPending,  int totalChecks,  int passedChecks,  int failedChecks,  double verificationScore,  List<String> redFlags,  List<String> verifiedDocuments,  String? assignedVerifier,  DateTime? completedAt,  String? recommendation)?  $default,) {final _that = this;
switch (_that) {
case _ClaimVerificationModel() when $default != null:
return $default(_that.id,_that.claimId,_that.patientName,_that.providerName,_that.claimAmount,_that.claimDate,_that.status,_that.checksCompleted,_that.checksPending,_that.totalChecks,_that.passedChecks,_that.failedChecks,_that.verificationScore,_that.redFlags,_that.verifiedDocuments,_that.assignedVerifier,_that.completedAt,_that.recommendation);case _:
  return null;
...
class _ClaimVerificationModel extends ClaimVerificationModel {
  const _ClaimVerificationModel({required this.id, required this.claimId, required this.patientName, required this.providerName, required this.claimAmount, required this.claimDate, required this.status, required final  List<String> checksCompleted, required final  List<String> checksPending, required this.totalChecks, required this.passedChecks, required this.failedChecks, required this.verificationScore, required final  List<String> redFlags, required final  List<String> verifiedDocuments, this.assignedVerifier, this.completedAt, this.recommendation}): _checksCompleted = checksCompleted,_checksPending = checksPending,_redFlags = redFlags,_verifiedDocuments = verifiedDocuments,super._();
  factory _ClaimVerificationModel.fromJson(Map<String, dynamic> json) => _$ClaimVerificationModelFromJson(json);
...
@override final  String status;
 final  List<String> _checksCompleted;
@override List<String> get checksCompleted {
 ...
 final  List<String> _checksPending;
@override List<String> get checksPending {
...
/// @nodoc
abstract mixin class _$ClaimVerificationModelCopyWith<$Res> implements $ClaimVerificationModelCopyWith<$Res> {
  factory _$ClaimVerificationModelCopyWith(_ClaimVerificationModel value, $Res Function(_ClaimVerificationModel) _then) = __$ClaimVerificationModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String claimId, String patientName, String providerName, double claimAmount, DateTime claimDate, String status, List<String> checksCompleted, List<String> checksPending, int totalChecks, int passedChecks, int failedChecks, double verificationScore, List<String> redFlags, List<String> verifiedDocuments, String? assignedVerifier, DateTime? completedAt, String? recommendation
});
...
/// @nodoc
class __$ClaimVerificationModelCopyWithImpl<$Res>
    implements _$ClaimVerificationModelCopyWith<$Res> {
  __$ClaimVerificationModelCopyWithImpl(this._self, this._then);

  final _ClaimVerificationModel _self;
  final $Res Function(_ClaimVerificationModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? claimId = null,Object? patientName = null,Object? providerName = null,Object? claimAmount = null,Object? claimDate = null,Object? status = null,Object? checksCompleted = null,Object? checksPending = null,Object? totalChecks = null,Object? passedChecks = null,Object? failedChecks = null,Object? verificationScore = null,Object? redFlags = null,Object? verifiedDocuments = null,Object? assignedVerifier = freezed,Object? completedAt = freezed,Object? recommendation = freezed,}) {
  return _then(_ClaimVerificationModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,claimId: null == claimId ? _self.claimId : claimId // ignore: cast_nullable_to_non_nullable
as String,patientName: null == patientName ? _self.patientName : patientName // ignore: cast_nullable_to_non_nullable
as String,providerName: null == providerName ? _self.providerName : providerName // ignore: cast_nullable_to_non_nullable
...
as double,claimDate: null == claimDate ? _self.claimDate : claimDate // ignore: cast_nullable_to_non_nullable
as DateTime,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as String,checksCompleted: null == checksCompleted ? _self._checksCompleted : checksCompleted // ignore: cast_nullable_to_non_nullable
as List<String>,checksPending: null == checksPending ? _self._checksPending : checksPending // ignore: cast_nullable_to_non_nullable
as List<String>,totalChecks: null == totalChecks ? _self.totalChecks : totalChecks // ignore: cast_nullable_to_non_nullable
as int,passedChecks: null == passedChecks ? _self.passedChecks : passedChecks // ignore: cast_nullable_to_non_nullable
as int,failedChecks: null == failedChecks ? _self.failedChecks : failedChecks // ignore: cast_nullable_to_non_nullable
as int,verificationScore: null == verificationScore ? _self.verificationScore : verificationScore // ignore: cast_nullable_to_non_nullable
