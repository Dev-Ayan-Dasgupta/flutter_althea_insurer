...
/// @nodoc
abstract mixin class $InvestigationCaseModelCopyWith<$Res>  {
  factory $InvestigationCaseModelCopyWith(InvestigationCaseModel value, $Res Function(InvestigationCaseModel) _then) = _$InvestigationCaseModelCopyWithImpl;
@useResult
$Res call({
 String id, String caseNumber, String title, String status, String priority, String outcome, List<String> claimIds, String primarySuspect, String suspectType, double totalAmountInvolved, double recoveredAmount, int relatedClaims, DateTime openedAt, DateTime? closedAt, String investigator, List<String> evidenceCollected, List<String> findings, String? actionTaken
});
...
/// @nodoc
class _$InvestigationCaseModelCopyWithImpl<$Res>
    implements $InvestigationCaseModelCopyWith<$Res> {
  _$InvestigationCaseModelCopyWithImpl(this._self, this._then);

  final InvestigationCaseModel _self;
  final $Res Function(InvestigationCaseModel) _then;
...
as String,claimIds: null == claimIds ? _self.claimIds : claimIds // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [InvestigationCaseModel].
extension InvestigationCaseModelPatterns on InvestigationCaseModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _InvestigationCaseModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _InvestigationCaseModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _InvestigationCaseModel value)  $default,){
final _that = this;
switch (_that) {
case _InvestigationCaseModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _InvestigationCaseModel value)?  $default,){
final _that = this;
switch (_that) {
case _InvestigationCaseModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String caseNumber,  String title,  String status,  String priority,  String outcome,  List<String> claimIds,  String primarySuspect,  String suspectType,  double totalAmountInvolved,  double recoveredAmount,  int relatedClaims,  DateTime openedAt,  DateTime? closedAt,  String investigator,  List<String> evidenceCollected,  List<String> findings,  String? actionTaken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _InvestigationCaseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String caseNumber,  String title,  String status,  String priority,  String outcome,  List<String> claimIds,  String primarySuspect,  String suspectType,  double totalAmountInvolved,  double recoveredAmount,  int relatedClaims,  DateTime openedAt,  DateTime? closedAt,  String investigator,  List<String> evidenceCollected,  List<String> findings,  String? actionTaken)  $default,) {final _that = this;
switch (_that) {
case _InvestigationCaseModel():
return $default(_that.id,_that.caseNumber,_that.title,_that.status,_that.priority,_that.outcome,_that.claimIds,_that.primarySuspect,_that.suspectType,_that.totalAmountInvolved,_that.recoveredAmount,_that.relatedClaims,_that.openedAt,_that.closedAt,_that.investigator,_that.evidenceCollected,_that.findings,_that.actionTaken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String caseNumber,  String title,  String status,  String priority,  String outcome,  List<String> claimIds,  String primarySuspect,  String suspectType,  double totalAmountInvolved,  double recoveredAmount,  int relatedClaims,  DateTime openedAt,  DateTime? closedAt,  String investigator,  List<String> evidenceCollected,  List<String> findings,  String? actionTaken)?  $default,) {final _that = this;
switch (_that) {
case _InvestigationCaseModel() when $default != null:
return $default(_that.id,_that.caseNumber,_that.title,_that.status,_that.priority,_that.outcome,_that.claimIds,_that.primarySuspect,_that.suspectType,_that.totalAmountInvolved,_that.recoveredAmount,_that.relatedClaims,_that.openedAt,_that.closedAt,_that.investigator,_that.evidenceCollected,_that.findings,_that.actionTaken);case _:
  return null;
...
/// @nodoc
abstract mixin class _$InvestigationCaseModelCopyWith<$Res> implements $InvestigationCaseModelCopyWith<$Res> {
  factory _$InvestigationCaseModelCopyWith(_InvestigationCaseModel value, $Res Function(_InvestigationCaseModel) _then) = __$InvestigationCaseModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String caseNumber, String title, String status, String priority, String outcome, List<String> claimIds, String primarySuspect, String suspectType, double totalAmountInvolved, double recoveredAmount, int relatedClaims, DateTime openedAt, DateTime? closedAt, String investigator, List<String> evidenceCollected, List<String> findings, String? actionTaken
});
...
/// @nodoc
class __$InvestigationCaseModelCopyWithImpl<$Res>
    implements _$InvestigationCaseModelCopyWith<$Res> {
  __$InvestigationCaseModelCopyWithImpl(this._self, this._then);

  final _InvestigationCaseModel _self;
  final $Res Function(_InvestigationCaseModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? caseNumber = null,Object? title = null,Object? status = null,Object? priority = null,Object? outcome = null,Object? claimIds = null,Object? primarySuspect = null,Object? suspectType = null,Object? totalAmountInvolved = null,Object? recoveredAmount = null,Object? relatedClaims = null,Object? openedAt = null,Object? closedAt = freezed,Object? investigator = null,Object? evidenceCollected = null,Object? findings = null,Object? actionTaken = freezed,}) {
  return _then(_InvestigationCaseModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,caseNumber: null == caseNumber ? _self.caseNumber : caseNumber // ignore: cast_nullable_to_non_nullable
as String,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as String,priority: null == priority ? _self.priority : priority // ignore: cast_nullable_to_non_nullable
as String,outcome: null == outcome ? _self.outcome : outcome // ignore: cast_nullable_to_non_nullable
as String,claimIds: null == claimIds ? _self._claimIds : claimIds // ignore: cast_nullable_to_non_nullable
as List<String>,primarySuspect: null == primarySuspect ? _self.primarySuspect : primarySuspect // ignore: cast_nullable_to_non_nullable
as String,suspectType: null == suspectType ? _self.suspectType : suspectType // ignore: cast_nullable_to_non_nullable
as String,totalAmountInvolved: null == totalAmountInvolved ? _self.totalAmountInvolved : totalAmountInvolved // ignore: cast_nullable_to_non_nullable
as double,recoveredAmount: null == recoveredAmount ? _self.recoveredAmount : recoveredAmount // ignore: cast_nullable_to_non_nullable
