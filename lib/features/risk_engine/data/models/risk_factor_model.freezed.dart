...
mixin _$RiskFactorModel {
 ...
 String get id; String get name; String get category; double get impactScore; String get description; bool get isModifiable; String? get currentValue; String? get targetValue;
...
@override
String toString() {
  return 'RiskFactorModel(id: $id, name: $name, category: $category, impactScore: $impactScore, description: $description, isModifiable: $isModifiable, currentValue: $currentValue, targetValue: $targetValue)';
}
...
@useResult
$Res call({
 String id, String name, String category, double impactScore, String description, bool isModifiable, String? currentValue, String? targetValue
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String category,  double impactScore,  String description,  bool isModifiable,  String? currentValue,  String? targetValue)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RiskFactorModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String category,  double impactScore,  String description,  bool isModifiable,  String? currentValue,  String? targetValue)  $default,) {final _that = this;
switch (_that) {
case _RiskFactorModel():
return $default(_that.id,_that.name,_that.category,_that.impactScore,_that.description,_that.isModifiable,_that.currentValue,_that.targetValue);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String category,  double impactScore,  String description,  bool isModifiable,  String? currentValue,  String? targetValue)?  $default,) {final _that = this;
switch (_that) {
case _RiskFactorModel() when $default != null:
return $default(_that.id,_that.name,_that.category,_that.impactScore,_that.description,_that.isModifiable,_that.currentValue,_that.targetValue);case _:
  return null;
...
class _RiskFactorModel extends RiskFactorModel {
  const _RiskFactorModel({required this.id, required this.name, required this.category, required this.impactScore, required this.description, required this.isModifiable, this.currentValue, this.targetValue}): super._();
